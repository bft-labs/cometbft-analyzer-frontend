...
export async function GET(request: NextRequest) {
  ...
  let apiUrl = "https://api.vizrat.com/v1/metrics/network/latency/node-stats";
  ...
  if (queryParams.toString()) {
    ...
    apiUrl =
      "https://api.vizrat.com/v1/metrics/network/latency/node-stats?from=2025-06-28T15:22:28.766Z&to=2025-06-28T15:29:54.249Z";
  }
