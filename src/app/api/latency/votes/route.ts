...
export async function GET(request: NextRequest) {
  ...
  let apiUrl = "https://api.educhain.guru/v1/metrics/latency/votes";
  ...
  if (queryParams.toString()) {
    ...
    apiUrl =
      "https://api.educhain.guru/v1/metrics/latency/votes?from=2025-06-28T15%3A22%3A28.766Z&to=2025-06-28T15%3A29%3A54.249Z&page=1&perPage=100&threshold=p95";
  }
